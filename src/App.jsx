...
export default function App() {
  ...
  const markOwnerPaid = (ownerId) => {
    ...
    // Tag jobs as paid instead of deleting
  ...
  const addHorse = () => {
    ...
    const id = uid();
    setHorses((p) => [{ id, name: n, ownerId: owner.id }, ...p]);
  };
            ...
            {jobs.map((j) => (
              <div key={j.key} className="rowline small">
                ...
                <div className="hstack">
                  ...
                  <button className="btn sm danger" onClick={() => removeJob(j.key)}>
                    🗑
                  </button>
                </div>
              </div>
      ...
      <div className="container" style={{ paddingTop: "12px" }}>
        {tab === "daily" && (
          <div className="row">
            ...
            {/* Right column - Owners / Paid History */}
