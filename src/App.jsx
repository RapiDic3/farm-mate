...
export default function App() {
  ...
  // ── (DayModal, DailyView, OwnersView, SettingsView)
    ...
    <div className="container">
      <header
        ...
        style={{
          background: "#0ea5e9",
          color: "#fff",
          padding: "24px", // ⬆️ increased padding to make header bigger
      ...
      >
        <div style={{ fontWeight: 800, fontSize: "26px" }}>Farm Mate</div> {/* ⬆️ slightly larger font */}
